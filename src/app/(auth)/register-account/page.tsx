      ...
      <div className='mx-6 mt-40 lg:flex lg:items-center lg:justify-center lg:mt-0 lg:min-h-screen'>
        <div className='lg:max-w-md lg:w-full lg:px-8'>
          <div className='flex flex-col w-58 lg:w-full'>
            <h1 className='text-2xl font-extrabold lg:text-3xl lg:text-center lg:mt-8'>Sign Up</h1>
            <p className='text-gray-600 font-medium lg:text-center lg:mt-2'>Become a Regigio member today!!!</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className='flex-col mt-14 lg:mt-8'>
            ...
            <div className='mb-8'>
              <p className='font-normal mb-2'>Confirm Password</p>
              <Input
            ...
            <div className='flex flex-col items-center'>
              ...
              <p className='font-normal mt-8 text-center mb-8'>
